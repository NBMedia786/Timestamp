...
- Each timestamp range can ONLY appear in ONE category
- Never list the same time range (e.g., [01:23 - 02:45]) in multiple categories
- If a segment has mixed characteristics, choose the PRIMARY/DOMINANT characteristic
- Make a definitive decision based on the strongest visual indicator

**RULE 2: VISUAL FOOTAGE FIRST, THEN TEXT OVERLAYS**
- PRIMARILY categorize based on CAMERA TYPE and VISUAL FOOTAGE characteristics
- SECONDARILY consider on-screen text overlays/labels (e.g., "BODYCAM", "CCTV CAMERA 3")
- NEVER categorize based on audio/dialogue content alone

**RULE 3: DECISION HIERARCHY** (Use this order to make your decision):
1. Check for on-screen text labels/overlays identifying footage type
2. Identify camera mounting position and perspective
3. Analyze visual characteristics (movement, angle, environment)
4. Choose the MOST DOMINANT characteristic if multiple apply

**VISUAL IDENTIFICATION GUIDE:**

1. **BODYCAM FOOTAGE** - Identify by these VISUAL characteristics:
   - First-person perspective (POV) from chest/shoulder height
   - Camera shake from walking/movement
   - Visible police equipment (radio, badge, uniform sleeves) at edges
   - Officer's arms/hands often visible in frame
   - Wide-angle lens distortion
   - Moving through spaces from officer's viewpoint

2. **DASHCAM FOOTAGE** - Identify by these VISUAL characteristics:
   - Fixed forward-facing view from inside vehicle
   - Visible vehicle hood/dashboard/windshield frame
   - Road/street view with pavement markers
   - Stationary or moving vehicle perspective
   - Often split-screen or timestamp overlay
   - Traffic/road elements prominently featured

3. **CCTV FOOTAGE** - Identify by these VISUAL characteristics:
   - Fixed, static camera position (no camera movement)
   - High-angle or corner-mounted perspective
   - Wide coverage of an area (parking lot, hallway, room)
   - Timestamp/camera ID overlay (often in corner)
   - Black and white or low-quality footage
   - Security camera aesthetic

4. **INTERROGATION** - Identify by these VISUAL characteristics:
   - Small indoor room with minimal furniture
   - Suspect/person seated at table, often handcuffed
   - Plain walls (often beige/gray)
   - Fixed camera angle(s), often from corner or wall-mounted
   - Formal questioning setup visible
   - Recording timestamp visible

5. **INTERVIEW** - Identify by these VISUAL characteristics:
   - Professional setting (office, studio, outdoor location)
   - More comfortable seating arrangement
   - Witness or media personnel visible
   - More casual environment than interrogation
   - May have multiple people in frame
   - Less restrictive atmosphere

6. **911 CALLS** - Identify by these characteristics:
   - Audio ONLY (no corresponding visual footage), OR
   - Static screen with text "911 Call" or dispatch audio overlay
   - Dispatcher voice heard without corresponding visual action

7. **INVESTIGATION** - Identify by these VISUAL characteristics:
   - Evidence being collected, photographed, or examined
   - Crime scene tape/markers visible
   - Multiple investigators/detectives in frame
   - Focus on physical evidence or locations
   - Evidence bags, cameras, collection tools visible

**SMART DECISION MAKING EXAMPLES:**

Example 1: BODYCAM footage shows officer interviewing a witness
- Screen overlay says: "OFFICER BODYCAM"
- Visual: First-person POV, camera shake, officer's hands visible
- Audio: Interview conversation
- **CORRECT CATEGORY: BODYCAM FOOTAGE** (camera type wins)

Example 2: CCTV footage shows interrogation room
- Screen overlay says: "CAMERA 2 - INTERROGATION ROOM"
- Visual: Fixed high angle, static camera
- Audio: Suspect being questioned
- **CORRECT CATEGORY: INTERROGATION** (room type + overlay wins)

Example 3: Dashcam during traffic stop conversation
- Visual: Fixed forward view, vehicle hood visible
- Audio: Officer questioning driver
- **CORRECT CATEGORY: DASHCAM FOOTAGE** (camera mounting wins)

Example 4: Fixed camera in interview room
- Visual: Professional setting, comfortable chairs, corner-mounted camera
- Audio: Witness giving statement
- No harsh/restrictive setup
- **CORRECT CATEGORY: INTERVIEW** (environment type wins)

**DO NOT** categorize based on:
- What people are talking about
- What topics are being discussed
- The subject matter of conversation
- Keywords in dialogue (e.g., hearing "interrogation" doesn't mean it's INTERROGATION category)

**ALWAYS** categorize based on (in priority order):
1. On-screen text overlays/labels
2. Camera type and mounting position
3. Visual perspective and angle
4. Physical environment and room setup
5. Technical characteristics of the footage

**CONFLICT RESOLUTION:**
- If BODYCAM shows someone being interviewed → BODYCAM (camera type wins)
- If CCTV shows interrogation → Use room characteristics to decide between CCTV/INTERROGATION
- If DASHCAM shows investigation → DASHCAM (camera type wins)
- When truly ambiguous, choose based on the STRONGEST VISUAL INDICATOR
...
1. **NO DUPLICATES**: Each time range appears ONLY ONCE across all categories
2. **ONE DECISION**: Make ONE definitive category choice per timestamp
3. **VISUAL FIRST**: Base decision on camera type and visual characteristics
4. **USE OVERLAYS**: Check on-screen text labels for footage type identification
5. **BE SMART**: Analyze the actual footage/clip, not just what's being said

**CATEGORIZATION PRIORITY:**
- If bodycam footage shows an officer talking to a witness → Category: BODYCAM FOOTAGE (not INTERVIEW)
- If dashcam shows a traffic stop where officer questions driver → Category: DASHCAM FOOTAGE (not INTERROGATION)
- If CCTV shows people talking in a hallway → Category: CCTV FOOTAGE (not INTERVIEW)
- If interrogation room camera shows questioning → Category: INTERROGATION (room type wins)
- If screen says "BODYCAM" → Category: BODYCAM FOOTAGE (overlay wins)
